package com.davideploy.brazilnews;

import android.app.Application;

/**
 * Notas do Orientador: Centralizamos uma instância do contexto em nosso {@link App} (mesmo sendo um "anti-pattern") para extrairmos o máximo dos nossos
